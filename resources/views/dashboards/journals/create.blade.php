...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('dashboards.journals.store') }}" method="POST">
                                ...
                                <input type="hidden" name="amount" id="amount_nominal">
                                <div class="mb-3">
                                    ...
                                    <select name="transaction_id"
                                        ...
                                        <option value="" disabled selected>Tidak ada Transaksi</option>
                                        @else
                                ...
                                <div id="transactionDetails" style="display: none;">
                                    ...
                                    <p><strong>Keterangan:</strong> <span id="description"></span></p>
    ...
    <script>
        document.getElementById('transaction_id').addEventListener('change', function() {
            ...
            document.getElementById('amount_nominal').value = option.getAttribute('data-amount');
